...
class FlowchartMixin:
    ...
    def _open_all_masks_window(self):
        ...
        rgb_nodes = [
            ...
            ("rgb_hsv_H_cmap", 3, 1, " 4c Hue cmap"),
            ("rgb_hsv_S_cmap", 4, 1, " 5c Sat cmap"),
            ("rgb_hsv_V_cmap", 5, 1, " 6c Val cmap"),
            ("rgb_m1",        2, 2, " 7  Hue mask 1"),
            ("rgb_m2",        3, 2, " 8  Hue mask 2"),
            ("rgb_hsv_mask",  4, 2, " 9  HSV mask"),
            ("rgb_bgsub",     5, 2, "10  BG sub"),
            ("rgb_mask_pre",  6, 2, "11  Pre-pipeline"),
            *[(f"rgb_step{i+1}",
               rgb_positions[i][0],
               rgb_positions[i][1],
               f"S{i+1}: ?")
        ...
        rgb_edges = [
            ...
            ("rgb_hsv_H",    "rgb_hsv_S"),
            ("rgb_hsv_S",    "rgb_hsv_V"),
            ("rgb_hsv_H",    "rgb_hsv_H_cmap"),
            ("rgb_hsv_S",    "rgb_hsv_S_cmap"),
            ("rgb_hsv_V",    "rgb_hsv_V_cmap"),
            ("rgb_hsv_full", "rgb_m1"),
            ("rgb_hsv_full", "rgb_m2"),
            ("rgb_m1",       "rgb_m2",         "OR"),
            ("rgb_m2",       "rgb_hsv_mask"),
        ...
        for up in user_pipes:
            ...
            # Step nodes start one row AFTER the last info row, so
            # the wrapped info thumbnails never collide with steps.
            _step_base = _info_max_row + 1
    ...
    def _on_zoom_hover(self, event, view_name):
        ...
        try:
            ...
            if low.endswith("_h1_mask") or low.endswith("_h2_mask"):
                ...
                channel = "IR"
            elif low.endswith("_hsv_h") or low.endswith("_hsv_h_cmap"):
                channel = "H"
            elif low.endswith("_hsv_s") or low.endswith("_hsv_s_cmap"):
                channel = "S"
            elif low.endswith("_hsv_v") or low.endswith("_hsv_v_cmap"):
                channel = "V"
