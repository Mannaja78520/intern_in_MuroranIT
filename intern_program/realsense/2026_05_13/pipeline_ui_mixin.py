...
class PipelineUIMixin:
    ...
    def _on_add_step(self, parent_frame, pipeline_list):
        ...
        # We deliberately do NOT auto-refresh: rebuilding the All-Masks
        # canvas + reprocessing the frame is expensive, and adding a
        # step is usually followed by tuning its params. The user
    ...
    def _on_remove_step(self, parent_frame, pipeline_list, idx):
        ...
        # Same deferred-refresh policy as _on_add_step.
        self._rebuild_pipeline_ui(parent_frame, pipeline_list)
