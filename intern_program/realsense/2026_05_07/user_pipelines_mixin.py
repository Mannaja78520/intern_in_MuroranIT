...
class UserPipelinesMixin:
    ...
    def _on_add_user_pipeline(self):
        ...
        rec = {
            ...
            # Per-branch BG subtractor with its own MOG2 instance and
            # its own history / varThreshold parameters. The instance
            # is held on the rec under "_backSub" and is rebuilt
