...
#   "lab"     - ignore HSV; threshold the LAB a* / b* channels. a* is
#               the red<->green axis, b* the yellow<->blue axis; white,
#               gray and black ALL sit near a*=b*=128, so a coloured
#               object pops out regardless of how bright/dark the
#               background is. Best for "red on white AND on black".
#   "hsv_lab" - run BOTH the HSV hue detector and the LAB a*/b*
